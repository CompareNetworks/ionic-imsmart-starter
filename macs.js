  ...
  var api = {
    ...
    getItemThumbnails: function (id, success, failure) {
      ...
      this.getRequiredAssetDetails(id,
        ...
        function (data) {
          if (data) {
            api.getDocumentPath(function (docData) {
    ...
    getFilePathForItemWithUniqueId: function (uniqueId, success, failure) {
      dispatch('getFilePathForItemWithUniqueId', {
    ...
    followUpEmailWithMultipleAttachments: function (emailObject, success, failure) {
      dispatch('followUpEmailWithMultipleAttachments', emailObject, success, failure);
    },
    ...
    loadURLRequest: function (data, success, failure) {
      dispatch('loadURLRequest', data, success, failure);
    },

    navigateToSSOView: function (success, failure) {
      dispatch('navigateToSSOView', {}, success, failure);
    },
